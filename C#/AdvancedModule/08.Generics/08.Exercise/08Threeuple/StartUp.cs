       ...
       public static void Main()
        {
            ...
            var firstCustomTuple = new Threeuple<string, string, string>(names, address, town);
            ...
            var secondCustomTuple = new Threeuple<string, int, bool>(personName, litersOfBeer, drunkOrNot);
            ...
            var thirdCustomTuple = new Threeuple<string, double, string>(name, accountBalance, bankName);
